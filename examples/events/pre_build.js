...
// directories with fs.makedirSync. Note we need to require('fs') to access these
// functions.

// This script demonstrates synchronous usage where we run a sequence of commands,
